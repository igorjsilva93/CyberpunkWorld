...
?>
    <section class="">
        <h1 class="titulo">NIGHT CITY CHANGES EVERY BODY</h1>
        <div class="info">
            <img class="frame" src="../imgs/img1.jpg" />
            <p class="conteudo">
    ...
    <section class="" id="LIVE">
        <h1 class="titulo-right">LIVE IN THE CITY OF THE FUTURE</h1>
        <div class="info">
            <p class="conteudo2">
            ...
            <img class="frame" src="../imgs/img2.jpg" />
        </div>
    <hr>
    <section class="" id="STEAL">
        <h1  class="titulo">STEAL THE IMPLANT THAT GRANTS ETERNAL LIFE</h1>
        <div class="info">
            <img class="frame" src="../imgs/img3.jpg" />
            <p class="conteudo">
