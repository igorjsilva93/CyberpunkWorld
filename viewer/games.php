...
?>
      <p class="conteudo">
        <h1>SHADOWRUN DRAGONFALL</h1>
         <img class="frame" src="../imgs/SHADOWRUN DRAGONFALL.jpg" width="20%" /><br><br><br><br><br>Shadowrun is a curious blend. Elves, Orcs, and magic spliced with hacking, street samurai, and giant corporations – it’s Tolkien mixed with Gibson, and it’s bloody marvellous. It’s a great pen & paper game, too, if you’re here for that.
...
What I can tell you, without spoiling things, is that you will spend most of your time infiltrating various facilities, employing firearms, magic, summoned spirits, and robots to get what you want. Oh yes, and you’ll be able to venture into cyberspace, where you’ll fight AI programs to hack into critical systems.
        ...
        <img class="frame" src="../imgs/FAR CRY 3BLOOD DRAGON.jpg" /><br><br>With a suitably neon and retro aesthetic, Far Cry 3: Blood Dragon has enough 80’s theatrics and showmanship to make Daft Punk green with envy. It also features giant genetically altered lizards and spawned one hell of a trailer. Throw in some tight first-person shooter gameplay into the mix, and you may come to understand why we reckon it’s the best DLC Ubisoft has ever made.
...
And it’s all so organic, too. There’s a strong temptation for developers to signpost choices that can be made, to the point where mission objectives explain precisely where you can go and what you need to do, but in Deus Ex, it’s all a surprise. You don’t know that hacking a computer and reading private emails will give you a code that lets you defeat a tough enemy without a fight. You also don’t know that there’s an item hidden within a level that will unlock a previous invisible, unimagined route to the mission objective – you need to go out and explore.</p>
    <br><br><hr></hr>
        ...
        <p class="conteudo">
        <h1>CLOUDPUNK</h1>
        <img class="frame" src="../imgs/CLOUDPUNK.jpg" /><br><br><br><br><br><br>Cloudpunk is like a cyberpunk theme park ride – strap yourself in and prepare to be served up a big slice of late-night neon metropolis with a dollop of rainy dystopia. You play as Rania, embarking upon a new job as a delivery driver, ferrying packages through streets piled high with skyscrapers and shimmering billboards.

The city is constructed from tiny blocks, which makes it more charming than gritty – but it’s a joy to explore, with numerous NPCs to natter with and some thoughtful quests spread throughout the game. If you’re hungry for cyberpunk, Cloudpunk is sure to sate your appetite.<br><br><br><br><br><br></p><hr></hr>

        <p class="conteudo">
        <h1>CYBERPUNK 2077</h1>
        <img class="frame" src="../imgs/CYBERPUNK 2077.jpeg" /><br><br><br><br>Based on the Cyberpunk 2020 table top game created in the 1980s, Cyberpunk 2077 takes players on a journey through the hyper-capitalist Night City as V, a mercenary on the hunt for the next big heist. There aren’t many games that use the cyberpunk setting as well as CD Projekt’s open-world action adventure game.
...
CD Projekt set the bar high for Cyberpunk 2077 coming off their 2015 smash hit RPG, The Witcher 3. Though they may have fallen short for some people, Cyberpunk 2077 is undoubtedly one of the most ambitious cyberpunk games ever made.<br><br><br><br><br><br><hr></hr>

    </p>

        <p class="conteudo">
        <h1>THE ASCENT</h1>
        <img class="frame" src="../imgs/The Ascent.jpeg" /><br><br><br><br><br><br>The Ascent is a co-op solo action RPG set in Veles, an overcrowded cyberpunk world.
