...
?>
        ...
        <h1>SHADOWRUN DRAGONFALL</h1>
         <img class="frame" src="../imgs/SHADOWRUN DRAGONFALL.jpg" width="30%" /><br><br><br><p class="conteudo">Shadowrun is a curious blend. Elves, Orcs, and magic spliced with hacking, street samurai, and giant corporations – it’s Tolkien mixed with Gibson, and it’s bloody marvellous. It’s a great pen & paper game, too, if you’re here for that.
...
What I can tell you, without spoiling things, is that you will spend most of your time infiltrating various facilities, employing firearms, magic, summoned spirits, and robots to get what you want. Oh yes, and you’ll be able to venture into cyberspace, where you’ll fight AI programs to hack into critical systems.
        ...
        <img class="frame" src="../imgs/FAR CRY 3BLOOD DRAGON.jpg" width="30%" /><br><br><p class="conteudo2">With a suitably neon and retro aesthetic, Far Cry 3: Blood Dragon has enough 80’s theatrics and showmanship to make Daft Punk green with envy. It also features giant genetically altered lizards and spawned one hell of a trailer. Throw in some tight first-person shooter gameplay into the mix, and you may come to understand why we reckon it’s the best DLC Ubisoft has ever made.
...
CD Projekt set the bar high for Cyberpunk 2077 coming off their 2015 smash hit RPG, The Witcher 3. Though they may have fallen short for some people, Cyberpunk 2077 is undoubtedly one of the most ambitious cyberpunk games ever made.<br><br><hr></hr>

    </p>

        
        <h1>THE ASCENT</h1>
        <img class="frame" src="../imgs/The Ascent.jpeg" width="30%" /><br>
        <p class="conteudo2">
...
You belong to the corporation. Can you survive without her? <br><br><br><hr></hr></p>
